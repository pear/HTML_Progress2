<?php
/**
 * API setCellCoordinates Unit tests for HTML_Progress2 class.
 *
 * @version    $Id$
...
class HTML_Progress2_TestCase_setCellCoordinates extends PHPUnit_TestCase
{
    /**
    ...
    function HTML_Progress2_TestCase_setCellCoordinates($name)
    {
