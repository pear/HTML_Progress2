<?php
/**
 * API setString Unit tests for HTML_Progress2 class.
 * 
 * @version    $Id$
...
class HTML_Progress2_TestCase_setString extends PHPUnit_TestCase
{
    /**
    ...
    function HTML_Progress2_TestCase_setString($name)
    {
