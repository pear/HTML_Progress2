<?php
/**
 * API setBorderPainted Unit tests for HTML_Progress2 class.
 * 
 * @version    $Id$
...
class HTML_Progress2_TestCase_setBorderPainted extends PHPUnit_TestCase
{
    /**
    ...
    function HTML_Progress2_TestCase_setBorderPainted($name)
    {
