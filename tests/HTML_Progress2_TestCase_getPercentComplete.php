<?php
/**
 * API getPercentComplete Unit tests for HTML_Progress2 class.
 *
 * @version    $Id$
...
class HTML_Progress2_TestCase_getPercentComplete extends PHPUnit_TestCase
{
    /**
    ...
    function HTML_Progress2_TestCase_getPercentComplete($name)
    {
