...
$pb->addLabel(HTML_PROGRESS2_LABEL_TEXT, 'txt1', 'Scriptaculous AJAX Progress2 example 1');
...
$pb->registerAJAX('auto_server.php', array('RequestStatusAndFx'), array('all', 'scriptaculous'));
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
    "http://www.w3c.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
<head>
<title>Scriptaculous Ajax Progress2 example 1</title>
<?php
if ($reuseCSS) {
...
//<![CDATA[
HTML_Progress2.serverClassName  = 'RequestStatusAndFx';
